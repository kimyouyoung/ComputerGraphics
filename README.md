...
**press keyboard 'v'** : draw the solar system with points(vertices).　
　**press keyboard 'w'** : draw the solar system with wireframe. 　
**defalut** : draw the solar system with a colored object.
