...
void specialkey(int key, int x, int y)
{
	...
	if (angle < 45)
	{
		...
		{
		case GLUT_KEY_LEFT:
			if (signX * abs(model_state.pos[0]) > -0.6f) {
		...
		case GLUT_KEY_RIGHT:
			...
			break;
		case GLUT_KEY_UP:
			if (signZ * abs(model_state.pos[2]) > -0.6f) {
...
void modelStateInit()
{
	...
	if (idx_selected == 1) {
		xAxis[0] = 2; yAxis[0] = 10; zAxis[0] = 2;
		xAxis[1] = 3; yAxis[1] = 10; zAxis[1] = 2;
		xAxis[2] = 2; yAxis[2] = 11; zAxis[2] = 2;
		xAxis[3] = 2; yAxis[3] = 12; zAxis[3] = 2;
	}
	else if (idx_selected == 2) {
		xAxis[0] = 2; yAxis[0] = 10; zAxis[0] = 2;
		xAxis[1] = 2; yAxis[1] = 11; zAxis[1] = 2;
		xAxis[2] = 2; yAxis[2] = 12; zAxis[2] = 2;
		xAxis[3] = 2; yAxis[3] = 13; zAxis[3] = 2;
	}
	else if (idx_selected == 3) {
		xAxis[0] = 2; yAxis[0] = 10; zAxis[0] = 2;
		xAxis[1] = 3; yAxis[1] = 10; zAxis[1] = 2;
		xAxis[2] = 2; yAxis[2] = 11; zAxis[2] = 2;
		xAxis[3] = 3; yAxis[3] = 11; zAxis[3] = 2;
	}
	else if (idx_selected == 4) {
		xAxis[0] = 2; yAxis[0] = 10; zAxis[0] = 2;
		xAxis[1] = 2; yAxis[1] = 11; zAxis[1] = 2;
		xAxis[2] = 1; yAxis[2] = 11; zAxis[2] = 2;
		xAxis[3] = 1; yAxis[3] = 12; zAxis[3] = 2;
	}
}
...
void idle()
{
	...
	if (1.0 * (curr_time - prev_time) / CLOCKS_PER_SEC > 1.0) {
		...
		for (int i = 0; i < 4; i++) {
			if ((yAxis[i] < 10 && yAxis[i] >= 0) && stack[xAxis[i]][yAxis[i] - 1][zAxis[i]]) {
				check = true;
				break;
			}
		}
		...
		if (model_state.pos[1] > min_y + box_cell && !check) {
			...
			for (int i = 0; i < 4; i++) {
				if (xAxis[i] >= 0 && xAxis[i] < 5 && yAxis[i] >= 0 && yAxis[i] < 10 && zAxis[i] >= 0 && zAxis[i] < 5)
					stack[xAxis[i]][yAxis[i]][zAxis[i]] = true;
			}
			if (!over)
				modelStateInit();
